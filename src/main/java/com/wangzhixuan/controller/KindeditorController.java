...
public class KindeditorController {
    ...
    public Object initKindeditor(HttpServletRequest request, HttpServletResponse response){

       try{
           //文件保存目录路径
           String savePath =  "E:\\javaWorlspace\\spring-shiro-training\\src\\main\\webapp\\kindeditor\\attached";
